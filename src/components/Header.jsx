...
const products = [
    { name: 'Suru Homes', description: 'We offer best of value in real estate', href: '#', icon: HomeModernIcon },
    { name: 'Suru Express', description: 'Hospitality at it best', href: '#', icon: BuildingOfficeIcon },
]
                        ...
                        >
                            <div className="p-4">
                                {products.map((item) => (
                                    ...
                                    >
                                        <div
                                            className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white border border-fuchsia-600">
